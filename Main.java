...
public class Main {
        public static void main(String[] args) {
                ...
                /*
                 * Modify this test class to make it more user friendly. Can you implement a
                 * circularly linked list to rotate between the various ToDoItems.
                 * As this will make this project very handy with user interactions. Although no
                 * GUI so far
                 */
